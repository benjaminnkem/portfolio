...
const Footer = () => {
  return (
    <>
      <footer className="py-10 border-t border-cyan-500">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li>
                      <Link href={"/"}>
                        <p className="text-lg font-light duration-200 inline-block hover:text-cyan-500">Home</p>
                      </Link>
                    </li>
                    <li>
                      <Link href={"/contact"}>
                        <p className="text-lg font-light duration-200 inline-block hover:text-cyan-500">Contact</p>
                      </Link>
                    </li>
                    <li>
                      <Link href={"/projects"}>
                        {" "}
                        <p className="text-lg font-light duration-200 inline-block hover:text-cyan-500">Projects</p>
                      </Link>
                    </li>
                  </ul>
                </div>
